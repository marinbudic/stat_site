...
def generate_pages_recursive(dir_path_content, template_path, dest_dir_path):
    ...
    for child in children:
        ...
        if os.path.isfile(path):
            ...
            os.mkdir(pub_path)
            generate_pages_recursive(path, template_path, pub_path)

def main():
    static = "/home/marinbudic/bootprojs/stat_site/static/"
    public = "/home/marinbudic/bootprojs/stat_site/public/"
    ...
    destination = "/home/marinbudic/bootprojs/stat_site/public/"
